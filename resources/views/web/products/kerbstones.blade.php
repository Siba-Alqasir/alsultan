                    ...
                    <div class="col-xl-12 col-lg-12">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                                            <div class="tp-product__filter d-flex justify-content-sm-end">
                                                <select id="filter-select">
                                                    <option value="all">{{_t('All Types')}}</option>
                        ...
                        <div class="tp-product-wrap">
                            <div class="row" id="products-container">
                                @include('web.products.partials.kerb-products', ['products' => $data['products'], 'page' => $data['page']])
                            </div>
...
$(document).ready(function() {
    ...
    function fetchProducts() {
        ...
        const typeValue = $('#filter-select').val();
        const url = `/products/by-category/${slug}?type=${typeValue}&search=${searchValue}&page=${currentPage}&locale=${locale}`;
