                ...
                <div class="col-md-10">
                    <div class="row justify-content-between">
                        <div class="col-xl-5 col-lg-6">
                            <img src="{{$data['is_mobile'] ? $data['inquiry_page_main']->getFirstMediaUrl('mobile_images') : $data['inquiry_page_main']->getFirstMediaUrl('images')}}"  class="w-100">
                        </div>
                        <div class="col-xl-6 offset-xl-1 col-lg-6">
                            <div class="tp-contact-form bg-white p-0">
                                <div class="tp-contact-form-wrap">
                                    ...
                                    <input class="d-none" type="text" name="type" value="inquiry">
