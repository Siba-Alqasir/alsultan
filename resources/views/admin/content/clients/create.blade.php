                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-control" name="type">
                                                    <option value="Trusted By">Trusted By</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="file" name="logo" class="form-control" id="logo_url" accept="image/*" required />
                                            </div>
                                        </div>                                        
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded" src="" id="logo_view">
                                            </div>
                                        </div>
                                    </div>
