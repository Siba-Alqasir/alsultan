                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                @if($key === 'en') required @endif value="{{$client->getTranslation('name',$key)}}">
                                        </div>
                                    </div>
                                </div>
                                @if($key === 'en')
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-1">
                                                <label class="form-label">Type <b>({{$locale['name']}})</b> @if($key === 'en')*@endif</label>
                                                <select class="form-control" name="type">
                                                    <option value="Trusted By" @if($client->type === 'Trusted By') selected @endif>Trusted By</option>
                                                    <option value="Contractors" @if($client->type === 'Contractors') selected @endif>Contractors</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="file" name="logo" class="form-control" id="logo_url" accept="image/*"  @if(!$client->getFirstMediaUrl('logo')) required @endif />
                                                </div>
                                            </div>                                        
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-1">
                                                    <img class="img-fluid rounded" src="{{$client->getFirstMediaUrl('logo')}}" id="logo_view">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
