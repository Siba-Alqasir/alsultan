                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                @if($key === 'en') required @endif value="{{$certificate->getTranslation('title',$key)}}">
                                        </div>
                                    </div>
                                </div>
                                @if($key === 'en')
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="file" name="logo" class="form-control" id="logo_url" accept="image/*"  @if(!$certificate->getFirstMediaUrl('logo')) required @endif />
                                                </div>
                                            </div>                                        
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-1">
                                                    <img class="img-fluid rounded" src="{{$certificate->getFirstMediaUrl('logo')}}" id="logo_view">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
