...
@section('title', 'Edit Quality Policy')
@section('content')
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control" name="description">{{$policy->getTranslation('description',$key)}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @if($key === 'en')
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="file" name="logo" class="form-control" id="logo_url" accept="image/*"  @if(!$policy->getFirstMediaUrl('logo')) required @endif />
                                                </div>
                                            </div>                                        
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-1">
                                                    <img class="img-fluid rounded" src="{{$policy->getFirstMediaUrl('logo')}}" id="logo_view">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
