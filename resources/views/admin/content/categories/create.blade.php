                            ...
                            <form method="POST" action="{{route('categories.store')}}"
                                ...
                                @if($key === 'en')
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="file" name="image" class="form-control" id="image_url" accept="image/*" required />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <label class="form-label">Upload Mobile Image *</label>
                                                <input type="file" name="mobile_image" class="form-control" id="image_url_mobile" accept="image/*" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded" src="" id="image_view">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded" src="" id="image_view_mobile">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded" src="" id="cover_mobile">
                                            </div>
                                        </div>
                                    </div>
                                @endif
