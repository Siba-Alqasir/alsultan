                ...
                <div class="tab-content pt-1">
                    @foreach($active_lang as $key=>$locale)
                        <div class="tab-pane @if($key === 'en') active @endif" id="add-{{$key}}" role="tabpanel"
                            ...
                            <form method="POST" action="{{route('treatments.update',$treatment->id)}}" enctype="multipart/form-data" id="form_{{$key}}">
                                {{ method_field('PUT') }}
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" name="ordering" class="form-control" value="{{$treatment->ordering}}" required>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                   value="{{$treatment->getTranslation('title',$key)}}"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control" name="description" id="summernote" >{{$treatment->getTranslation('description',$key)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-1">
                                        <label class="form-label">Features Description <b>({{$locale['name']}})</b></label>
                                        <textarea class="form-control" name="features_desc" >{{$treatment->getTranslation('features_desc',$key)}}</textarea>
                                    </div>
                                </div>
                                 @if($key === 'en')
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="file" name="image" class="form-control" id="image_url"
                                                       accept="image/*" @if(!$treatment->getFirstMediaUrl('images')) required @endif />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="file" name="mobile_image" style="height: 50%"
                                                       class="form-control" id="image_url_mobile" accept="image/*" @if(!$treatment->getFirstMediaUrl('mobile_images')) required @endif />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded" src="{{$treatment->getFirstMediaUrl('images')}}" id="image_view">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded" src="{{$treatment->getFirstMediaUrl('mobile_images')}}"  id="image_view_mobile">
                                            </div>
                                        </div>
                                    </div>
                                @endif
