                            ...
                            <form method="POST" action="{{route('treatments.store')}}" enctype="multipart/form-data"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control" name="features_desc"></textarea>
                                    </div>
                                </div>
                                @if($key === 'en')
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                ...
                                                <input type="file" name="mobile_image" style="height: 50%"
                                                       class="form-control" id="image_url_mobile" accept="image/*" required/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-1">
                                                <img class="img-fluid rounded"  id="image_view_mobile">
                                            </div>
                                        </div>
                                    </div>
                                @endif
