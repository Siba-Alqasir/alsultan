                ...
                <div class="card">
                    @can('sizes-create')
                        <div class="card-header" style="justify-content: end;">
                            <a type="button" class="btn btn-primary" href="{{route('sizes.create')}}"> Add Size</a>
                        </div>
                    @endcan
                    <div class="card-body">
                        <table class="datatables-basic table" id="item_tables">
                            ...
                            @foreach($sizes as $key=>$size)
                                <tr id="item_id_{{$size->id}}">
                                    <td class="text-center">{{++$key}}</td>
                                    <td class="text-center">{{$size->getTranslation('title','en')}}</td>
                                    <td class="text-center">
                                        ...
                                        @can('sizes-delete')
                                            <a type="button" class="btn btn-danger waves-effect waves-float waves-light"
                                               onclick="delete_item(this)" item_id="item_id_{{$size->id}}"
                                               item_url="{{route('sizes.destroy',$size->id)}}">Delete</a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
